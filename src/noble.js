/**
 * @fileoverview Cryptographic Utility Wrapper
 * Provides mapped access to Noble Ciphers, Hashes, and Post-Quantum Algorithms.
 */
...
// pqc libs
import { ml_kem512 as _ml_kem512, ml_kem768 as _ml_kem768, ml_kem1024 as _ml_kem1024 } from '@noble/post-quantum/ml-kem.js';
import { ml_dsa44 as _ml_dsa44, ml_dsa65 as _ml_dsa65, ml_dsa87 as _ml_dsa87 } from '@noble/post-quantum/ml-dsa.js';
import * as _slh_dsa from '@noble/post-quantum/slh-dsa.js';
import { falcon512 as _falcon512, falcon1024 as _falcon1024 } from '@noble/post-quantum/falcon.js';
...
/** @type {typeof _chacha} */
export const chacha = _chacha;
/** @type {typeof _salsa} */
export const salsa = _salsa;

/** @type {typeof _noble_hmac} */
export const noble_hmac = _noble_hmac;
/** @type {typeof _sha2} */
export const sha2 = _sha2;
/** @type {typeof _sha3} */
export const sha3 = _sha3;
/** @type {typeof _sha3_addons} */
export const sha3_addons = _sha3_addons;
/** @type {typeof _blake3_mod} */
export const blake3_mod = _blake3_mod;
/** @type {typeof _blake2} */
export const blake2 = _blake2;
/** @type {typeof _legacy} */
export const legacy = _legacy;

/** @type {typeof _ml_kem512} */
export const ml_kem512 = _ml_kem512;
/** @type {typeof _ml_kem768} */
export const ml_kem768 = _ml_kem768;
/** @type {typeof _ml_kem1024} */
export const ml_kem1024 = _ml_kem1024;

/** @type {typeof _ml_dsa44} */
export const ml_dsa44 = _ml_dsa44;
/** @type {typeof _ml_dsa65} */
export const ml_dsa65 = _ml_dsa65;
/** @type {typeof _ml_dsa87} */
export const ml_dsa87 = _ml_dsa87;

/** @type {typeof _slh_dsa} */
export const slh_dsa = _slh_dsa;

/** @type {typeof _falcon512} */
export const falcon512 = _falcon512;
/** @type {typeof _falcon1024} */
export const falcon1024 = _falcon1024;
 ...
 */
export const nobleMlkemMap = Object.freeze({
    // ML-KEM
    'ml_kem512': ml_kem512,
    'ml_kem_512': ml_kem512,
    'ml_kem768': ml_kem768,
    'ml_kem_768': ml_kem768,
    'ml_kem1024': ml_kem1024,
    'ml_kem_1024': ml_kem1024
});
 ...
 * @type {Readonly<Record<string, any>>}
 */
export const nobleMldsaMap = Object.freeze({
    // ML-DSA
    'ml_dsa44': ml_dsa44,
    'ml_dsa_44': ml_dsa44,
    'ml_dsa65': ml_dsa65,
 ...
 * @type {Readonly<Record<string, any>>}
 */
export const nobleFalconMap = Object.freeze({
    // Falcon
    'falcon512':  falcon512,
 ...
 * @type {Readonly<Record<string, any>>}
 */
export const nobleCipherMap = Object.freeze({
    // AES
    'aes_256_gcm': aes.gcm,
    'aes_256_ctr': aes.ctr,
    'aes_256_cfb': aes.cfb,
    'aes_256_siv': aes.gcmsiv,

    // ChaCha20
    'chacha20_poly1305': chacha.chacha20poly1305,
    'xchacha20_poly1305': chacha.xchacha20poly1305,
    'chacha20': chacha.chacha20,
    'xchacha20': chacha.xchacha20,

    // Salsa20
    'xsalsa20_poly1305': salsa.xsalsa20poly1305,
    'salsa20': salsa.salsa20,
    'xsalsa20': salsa.xsalsa20
});
 ...
 * @type {Readonly<Record<string, any>>}
 */
export const nobleHmacMap = Object.freeze({
    // SHA-2
    'sha224': sha2.sha224,
    'sha256': sha2.sha256,
    'sha384': sha2.sha384,
 ...
 * @type {Readonly<Record<string, any>>}
 */
export const nobleHashMap = Object.freeze({
    // SHA-2
    'sha224': sha2.sha224,
    'sha256': sha2.sha256,
    'sha384': sha2.sha384,
 ...
 * @type {Readonly<Record<string, any>>}
 */
export const nobleXofMap = Object.freeze({
    // SHAKE
    'shake128': sha3.shake128,
    'shake256': sha3.shake256,

    // cSHAKE
    'cshake128': sha3_addons.cshake128,
    'cshake256': sha3_addons.cshake256,

    // TurboSHAKE
    'turboshake128': sha3_addons.turboshake128,
    'turboshake256': sha3_addons.turboshake256,

    // KangarooTwelve
    'k12': sha3_addons.kt128,
    'kt128': sha3_addons.kt128,
    'kt256': sha3_addons.kt256
});
 ...
 * @type {Readonly<Record<string, any>>}
 */
export const nobleKmacMap = Object.freeze({
    // KMAC
    'kmac128': sha3_addons.kmac128,
    'kmac256': sha3_addons.kmac256,
});
 ...
 * @type {Readonly<Record<string, any>>}
 */
export const nobleAlgMap = Object.freeze({
    // Ciphers
    'aes': aes,
    'chacha': chacha,
    'salsa': salsa,
    ...
    // Hashes, HMAC, & XOFs
    'noble_hmac': noble_hmac,
    'sha2': sha2,
    'sha3': sha3,
    'sha3_addons': sha3_addons,
    'blake3_mod': blake3_mod,
    'blake2': blake2,
    'legacy': legacy,
